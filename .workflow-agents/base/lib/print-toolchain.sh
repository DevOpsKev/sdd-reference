#!/usr/bin/env bash
# Shared toolchain probe used by .workflow-agents/<agent>/run-*.sh
# debug blocks.
#
...
#
# Usage (sourced):
#   source /work/.workflow-agents/base/lib/print-toolchain.sh
#   print_toolchain node npm pnpm git curl
#
# Usage (executed):
#   /work/.workflow-agents/base/lib/print-toolchain.sh node npm pnpm
