...
Examples:
  pnpm execute spec claude sdd/specs/homepage dev
  pnpm execute spec claude sdd/specs/homepage qa
  AGENT_MAX_TURNS=20 pnpm execute spec vibe sdd/specs/homepage dev
  pnpm execute spec --tmp vibe sdd/specs/vite-baseline dev
EOF
}
