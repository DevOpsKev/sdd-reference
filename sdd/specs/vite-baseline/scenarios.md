...
**Spec reference:** `sdd/specs/vite-baseline/spec.md` line 57 (acceptance criteria)
...
**Spec reference:** `sdd/specs/vite-baseline/spec.md` line 56 (dist/ with assets)
...
**Spec reference:** `sdd/specs/vite-baseline/spec.md` lines 32 (TypeScript entry), 56 (build output)
...
**Spec reference:** `sdd/specs/vite-baseline/spec.md` line 31 (HTML entry)
